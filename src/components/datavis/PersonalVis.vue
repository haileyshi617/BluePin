...
export default {
  ...
  data() {
    return {
      dummyData: [
        { title: 'Total Rides', value: 59 },
        { title: 'Individual Trips', value: 20 },
        { title: 'Posted Trips', value: 18 },
        { title: 'Shared Trips', value: 39 },
        { title: 'Badge Number', value: 47 },
      ],
    };
  },
  mounted() {
    ...
    generateVis() {
      ...
      function mouseover(event, d) {
        ...
        tooltip
          ...
          .html(
            `<p class="content"><strong>${d.title}:</strong> ${d.value}</p>`
          )
